...
export const symptomsData = ["fine", "cramps", "acne", "cravings", "headache", "tender breast", "fatigue", "abdominal pain", "swelling", "vaginal discharge", "heartburn", "constipation", "nausea", "diarrhea", "insomnia", "morning sickness", "dizziness", "shortness of breath", "frequent urination", "None / I feel okay"];
...
export function Logs({ accessToken }) {
  ...
  async function getUserLogs() {
    ...
    try {
      ...
      if (!response.ok) {
        posthog.captureException("Logs.jsx getUserLogs();  Could not fetch logs");
      }
