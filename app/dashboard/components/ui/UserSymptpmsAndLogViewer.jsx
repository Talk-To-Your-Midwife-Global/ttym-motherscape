...
function ExcessCard({ num = 0 }) {
  return (
    <div
      className={cn("bg-white shadow-md h-[44px] w-[44px] text-lg flex items-center justify-center border border-primaryColor rounded-full text-primaryColor bg-[#0F969C12]")}>
